...
set_color = _$("ctx.fillStyle = (['none', 'gray', 'black', 'red'])[a]", 1);
...
add_cell = _$("map[pos + a%4 + parseInt(a/4)*10] = (([1,15,46,78,142,204])[b] & (1<<a)) ? 3 : 1");        
new_fig = _$("range(0, 7)(_$('add_cell(a,'+(Math.floor(Math.random()*5)+1)+')'))", 1);
