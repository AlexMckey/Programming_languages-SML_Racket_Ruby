...
use "d:/Dropbox/Devs/Projects/Ruby/hw7.sml";
...
let 
	val Point(a,b) = (preprocess_prog(LineSegment(1.0,2.0,1.0,2.0)))
...
let 
	val LineSegment(x1,y1,x2,y2) = (preprocess_prog(LineSegment(2.0,3.0,1.0,2.0)))
	val LineSegment(x,y,z,q)  = LineSegment(1.0,2.0,2.0,3.0) 
in
	if real_equal(x1,x) andalso real_equal(y1,y) andalso real_equal(x2,z) andalso real_equal(y2,q)
	then (print "eval_prog with shadowing 'a' in environment is working properly\n")
	else (print "eval_prog with shadowing 'a' in environment is not working properly\n")
end;

let 
	val LineSegment(x1,y1,x2,y2) = (preprocess_prog(LineSegment(2.0,3.0,2.0,2.0)))
	val LineSegment(x,y,z,q)  = LineSegment(2.0,2.0,2.0,3.0) 
in
	if real_equal(x1,x) andalso real_equal(y1,y) andalso real_equal(x2,z) andalso real_equal(y2,q)
	then (print "eval_prog with shadowing 'a' in environment is working properly\n")
	else (print "eval_prog with shadowing 'a' in environment is not working properly\n")
...
let 
	val LineSegment(x1,y1,x2,y2) = (preprocess_prog(LineSegment(1.0,3.0,2.0,2.0)))
	val LineSegment(x,y,z,q)  = LineSegment(1.0,3.0,2.0,2.0) 
in
	if real_equal(x1,x) andalso real_equal(y1,y) andalso real_equal(x2,z) andalso real_equal(y2,q)
	then (print "eval_prog with shadowing 'a' in environment is working properly\n")
	else (print "eval_prog with shadowing 'a' in environment is not working properly\n")
